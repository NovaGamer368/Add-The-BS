                    ...
                    <form onSubmit={create} className='container max-h-48 flex justify-center items-center h-screen py-6 px-10 max-w-full overflow-y-auto'>
                        <div className='w-3/4'>
                            <div className='relative'>
                                ...
                                <input type="text" id="default-search" className="block w-full h-18 p-4 pl-14 text-2xl border rounded-3xl bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Search for Actor..." required value={movieSearch} onChange={e => setMovieSearch(e.target.value)}/>
