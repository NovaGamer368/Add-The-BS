...
const Actor = ({ actor }) => {
  ...
  return (
    <div className="p-4 w-96 h-fit border rounded-lg bg-gray-800 border-gray-700">
      ...
      <a
        href={`/MovieInfo/${actor.id}`}
        className="flex justify-center items-center mb-8 px-6 py-2 text-sm font-medium text-center text-white text-wrap rounded-lg focus:ring-4 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
      >
